    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto">
                ...
                <a href="classes.html" class="nav-item nav-link">Echipa noastră</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Activități</a>
                    <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                        <a href="facility.html" class="dropdown-item">Evenimente</a>
                        <a href="team.html" class="dropdown-item">Galerie</a>
                    </div>
                </div>
                {{-- <div class="nav-item dropdown">
                ...
                <a href="contact.html" class="nav-item nav-link">Regimul zilei</a>
                <a href="contact.html" class="nav-item nav-link">Meniul</a>
